...
function main(config) {
  ...
  // ==================== 策略组 ====================
  const Anchor_OB = ['一键代理', '全局最优', '稳定备用', '低倍率节点', '高倍率节点', '香港节点', '澳门节点', '台湾节点', '日本节点', '韩国节点', '新加坡节点', '美国节点', '欧洲节点', '家宽节点', '其他节点'];
  const Anchor_SP = ['一键代理', '全局最优', '稳定备用', '低倍率节点', '高倍率节点', '香港节点', '澳门节点', '台湾节点', '日本节点', '韩国节点', '新加坡节点', '美国节点', '欧洲节点', '家宽节点', '其他节点', 'DIRECT'];
  const Anchor_AI = ['家宽节点', '美国节点', '一键代理', '低倍率节点', '高倍率节点', '香港节点', '澳门节点', '台湾节点', '日本节点', '韩国节点', '新加坡节点', '欧洲节点', '其他节点'];
  ...
  const regexRATE_LOW = '(?i)(0\\.[0-5]\\s*(x|×|倍)|(x|×)\\s*0\\.[0-5]|低倍|低倍率)';
  const regexRATE_HIGH = '(?i)(([2-9]|[1-9][0-9]+)(\\.[0-9]+)?\\s*(x|×|倍)|(x|×)\\s*([2-9]|[1-9][0-9]+)(\\.[0-9]+)?|高倍|高倍率)';
  ...
  config['proxy-groups'] = [
    { name: '一键代理', type: 'select', proxies: ['全局最优', '稳定备用', '低倍率节点', '高倍率节点', '香港节点', '澳门节点', '台湾节点', '日本节点', '韩国节点', '新加坡节点', '美国节点', '欧洲节点', '家宽节点', '其他节点'], icon: 'https://raw.githubusercontent.com/Seven1echo/Yaml/main/icons/Rocket.png' },
    ...
    { name: '低倍率节点', type: 'select', 'include-all': true, 'exclude-filter': excludeInfoFilter, filter: regexRATE_LOW },
    { name: '高倍率节点', type: 'select', 'include-all': true, 'exclude-filter': excludeInfoFilter, filter: regexRATE_HIGH },
