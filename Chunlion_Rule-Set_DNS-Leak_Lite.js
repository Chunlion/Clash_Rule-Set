...
function main(config) {
  ...
  config['proxy-groups'] = [
    { name: '一键代理', type: 'select', proxies: ['全局最优', '稳定备用', '香港节点', '日本节点', '澳门节点', '台湾节点', '韩国节点', '新加坡节点', '美国节点', '欧洲节点', '家宽节点', '其他节点'], icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Rocket.png' },
    { name: 'Streaming', type: 'select', proxies: Anchor_OB, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/YouTube.png' },
    { name: 'Telegram', type: 'select', proxies: Anchor_OB, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Telegram.png' },
    { name: 'Emby', type: 'select', proxies: Anchor_SP, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Emby.png' },
    { name: 'Google', type: 'select', proxies: Anchor_OB, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Google_Search.png' },
    ...
    { name: 'TikTok', type: 'select', proxies: Anchor_OB, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/TikTok.png' },
    ...
    { name: '其他节点', type: 'select', 'include-all': true, 'exclude-filter': excludeInfoFilter, filter: regexOT, icon: 'https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Global.png' }
  ];
  ...
  config['rules'] = [
    ...
    "RULE-SET,instagram_domain,Streaming",
    ...
    "RULE-SET,whatsapp_domain,Telegram",
    "RULE-SET,whatsapp_ip,Telegram,no-resolve",
  ...
  config['rule-providers'] = {
    ...
    vowifi_ip: { type: 'http', interval: 86400, behavior: 'ipcidr', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/UK-wifi-call-ip.mrs" },
    ...
    instagram_domain: { type: 'http', interval: 86400, behavior: 'domain', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/instagram_domain.mrs" },
    twitch_domain: { type: 'http', interval: 86400, behavior: 'domain', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/twitch_domain.mrs" },
    twitch_ip: { type: 'http', interval: 86400, behavior: 'ipcidr', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/twitch_ip.mrs" },
    ...
    line_domain: { type: 'http', interval: 86400, behavior: 'domain', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/line_domain.mrs" },
    line_ip: { type: 'http', interval: 86400, behavior: 'ipcidr', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/line_ip.mrs" },
    whatsapp_domain: { type: 'http', interval: 86400, behavior: 'domain', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/whatsapp_domain.mrs" },
    whatsapp_ip: { type: 'http', interval: 86400, behavior: 'ipcidr', format: 'mrs', url: "https://raw.githubusercontent.com/Chunlion/Clash_Rule-Set/main/rules/whatsapp_ip.mrs" },
